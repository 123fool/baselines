"""
Innovation 2: Bidirectional Temporal Regularization — Evaluation Script.

Uses the standard BrLP sampling pipeline (sample_using_controlnet_and_z) with
the BTR-trained ControlNet. Evaluation code is identical to baseline/Innovation 5
...
def evaluate_pair(autoencoder, diffusion, controlnet,
    ...
    """Evaluate one pair using standard BrLP sampling pipeline."""
...
if __name__ == '__main__':
    parser = argparse.ArgumentParser(description='Evaluate Innovation 2 BTR ControlNet')
    ...
    parser.add_argument('--model_name',  default='innovation_2_btr', type=str)
    args = parser.parse_args()

    os.makedirs(args.output_dir, exist_ok=True)

    print(f"[Innovation 2] Evaluation")
    ...
    summary = {
        ...
        'innovation': '2_bidirectional_temporal_regularization',
